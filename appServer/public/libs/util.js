...
//去掉具体时间
util.convertTime2StrNew = function(t){
    if(t == "" || t == undefined || t == "undefined"){
        return "暂无记录";
    }else{
        var ts = new Date(t);
...
util.callServerFunction = function(header, funcName, postData, callback, method)
{
    ...
    $.ajax(
    {
        type : method,
        async : true,
        url : 'http://test.soulkey99.com:8071/rest/' + funcName,  //api?m=   https://test.soulkey99.com:9071/rest/
        dataType : 'json',
        data : postData,
...
//app端调用的设置登录状态接口
util.setLoginSession = function(userIDApp,authSignApp){
    util.setSessionStorage("userID", userIDApp);
    util.setSessionStorage("authSign", authSignApp);
    //window.sessionStorage.setItem("userID", userID);
    //window.sessionStorage.setItem("authSign", authSign);
    if(window.location.href.indexOf("postedTopic")>=0){
